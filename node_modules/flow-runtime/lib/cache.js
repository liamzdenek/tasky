...
function memoize(object, propertyName, descriptor) {
...
function set(container, params, value) {
  var paramsLength = params.length;
  var cache = caches[paramsLength];
  if (!cache) {
    return;
  ...
  for (var i = 0; i < paramsLength; i++) {
    var param = params[i];
    (0, _invariant2.default)(subject instanceof WeakMap);
    if (i === paramsLength - 1) {
